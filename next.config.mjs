...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/trading/wastewater', destination: '/trading/wastewater-management', permanent: true },
      ...
      { source: '/trading/railings', destination: '/trading/architectural-railings', permanent: true },
      ...
      { source: '/trading/coating', destination: '/trading/wood-glass-metal-coating', permanent: true },
    ];
  },
};
