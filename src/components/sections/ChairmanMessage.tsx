        ...
        >
          <div className="relative mx-auto max-w-[420px] lg:mx-0">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-gradient-to-br from-accent-50 to-neutral-100">
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-neutral-charcoal/20 via-transparent to-transparent" />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="mt-0.5 text-xs font-semibold uppercase tracking-wider text-neutral-500">
